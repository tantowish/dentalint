    ...
    <section id="features" className="max-w-6xl mx-auto px-8 py-16">
        ...
        <div className="flex flex-col gap-8 pt-16 lg:pb-16 pb-8">
            <div className="flex flex-wrap">
                ...
                <div className="w-full lg:w-1/2 flex flex-col gap-3 lg:gap-4 justify-center p-8 text-center lg:text-left">
            ...
            <div className="flex flex-wrap">
                ...
                <div className="w-full lg:w-1/2 flex flex-col gap-3 lg:gap-4 justify-center p-8 text-center lg:text-left order-2 lg:order-1">
